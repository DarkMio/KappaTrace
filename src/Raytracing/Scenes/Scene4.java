...
public class Scene4 {
    ...
    private static void firstSceneFactory() {
        ...
        DepthPerspectiveCamera ppc = new DepthPerspectiveCamera(new Point3(3, 3, 3), new Vector3(-1, -1, -1), new Vector3(0, 1, 0), Math.PI / 4, new EvenlyDistributedPattern(3),0.35, 6);

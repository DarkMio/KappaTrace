...
public class SceneTexture {
    ...
    public static void SceneFactory() {
        ...
        ArrayList<Geometry> scene = new ArrayList<>(Arrays.asList(
                new Plane(new LambertMaterial(new InterpolatedImageTexture("./src/Resources/CheckerboardTexture.png")), new Point3(0, 0, 0), new Normal3(0, 1, 0)),
                new Sphere(new LambertMaterial(new InterpolatedImageTexture("./src/Resources/earth.png")), new Point3(1, 1, 1), 0.5),
                new AxisAlignedBox(new LambertMaterial(new InterpolatedImageTexture("./src/Resources/NoiseTexture.png")), new Point3(-1.5, 0.5, 0.5), new Point3(-0.5, 1.5, 1.5)),
                new Triangle(new LambertMaterial(new InterpolatedImageTexture("./src/Resources/ScratchTexture.png")), new Point3(0, 0, -2), up, new Point3(2, 0, -2), up, new Point3(2, 2, -2), up)
        ));

        Camera ppc = new DepthPerspectiveCamera(new Point3(3, 3, 3), new Vector3(-1, -1, -1), new Vector3(0, 1, 0), Math.PI/4, new EvenlyDistributedPattern(3), 0.35, 3.2);

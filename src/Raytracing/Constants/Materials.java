...
public class Materials {
    ...
    public static final LambertMaterial BLACK_LAMBERT = new LambertMaterial(Colors.BLACK);
    public static final LambertMaterial WHITE_LAMBERT = new LambertMaterial(Colors.WHITE);
    public static final LambertMaterial RED_LAMBERT = new LambertMaterial(Colors.RED);
    public static final LambertMaterial GREEN_LAMBERT = new LambertMaterial(Colors.GREEN);
    public static final LambertMaterial BLUE_LAMBERT = new LambertMaterial(Colors.BLUE);
    public static final LambertMaterial YELLOW_LAMBERT = new LambertMaterial(Colors.YELLOW);
    public static final LambertMaterial TEAL_LAMBERT = new LambertMaterial(Colors.TEAL);
    public static final LambertMaterial PURPLE_LAMBERT = new LambertMaterial(Colors.PURPLE);
    public static final LambertMaterial ORANGE_LAMBERT = new LambertMaterial(Colors.ORANGE);
